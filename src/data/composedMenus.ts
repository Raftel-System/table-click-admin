    ...
    steps: [
      {
        ...
        customOptions: [
          ...
          {
            id: 'poulet-grille',
            label: 'Sandwich poulet grillé',
            description: 'Filet de poulet grillé mariné',
            emoji: '🔥'
          },
          {
            id: 'filet-boeuf',
            label: 'Sandwich filet de bœuf',
    ...
    steps: [
      {
        ...
        customOptions: [
          ...
          { id: 'poulet-grille', label: 'Sandwich poulet grillé', emoji: '🔥' },
          { id: 'filet-boeuf', label: 'Sandwich filet de bœuf', emoji: '🥩' }
        ]
      },
      {
        id: 'beignets',
